...
@patch("pint.plugins.avatax.cache.set")
def test_calculate_checkout_total_use_cache(
    ...
    monkeypatch.setattr("pint.plugins.avatax.cache.get", mocked_cache)
...
def test_calculate_checkout_total_save_avatax_response_in_cache(
    ...
    monkeypatch.setattr("pint.plugins.avatax.api_post_request", mocked_avalara)
