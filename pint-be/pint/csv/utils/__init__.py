class InitiativeExportFields:
    """Data structure with fields for initiative export."""
    ...
    HEADERS_TO_FIELDS_MAPPING = {
        "fields": {
            ...
            # "initiative type": "initiative_type__name",
            # "charge taxes": "charge_taxes",
            # "initiative weight": "initiative_weight",
    ...
    #     "value_reference_initiative": "attributes__values__reference_initiative",
    # }
    #
    # INITIATIVE_CHANNEL_LISTING_FIELDS = {
    #     "channel_pk": "channel_listings__channel__pk",
    #     "slug": "channel_listings__channel__slug",
    #     "initiative_currency_code": "channel_listings__currency",
    ...
    #     "value_reference_initiative": "variants__attributes__values__reference_initiative",
    # }
    #
