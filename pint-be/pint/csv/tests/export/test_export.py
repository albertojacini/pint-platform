...
@patch("pint.csv.utils.export.create_file_with_headers")
@patch("pint.csv.utils.export.export_products_in_batches")
@patch("pint.csv.utils.export.send_export_download_link_notification")
@patch("pint.csv.utils.export.save_csv_file_in_export_file")
...
@patch("pint.csv.utils.export.create_file_with_headers")
@patch("pint.csv.utils.export.export_gift_cards_in_batches")
@patch("pint.csv.utils.export.send_export_download_link_notification")
@patch("pint.csv.utils.export.save_csv_file_in_export_file")
...
@patch("pint.csv.utils.export.BATCH_SIZE", 1)
