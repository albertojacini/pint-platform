...
DATABASE_ROUTERS = ["pint.core.db_routers.PrimaryReplicaRouter"]
...
JWT_MANAGER_PATH = os.environ.get(
    "JWT_MANAGER_PATH", "pint.core.jwt_manager.JWTManager"
)
...
LOGGING = {
    ...
    "formatters": {
        ...
        "json": {
            "()": "pint.core.logging.JsonFormatter",
        ...
        "celery_json": {
            "()": "pint.core.logging.JsonCeleryFormatter",
            "datefmt": "%Y-%m-%dT%H:%M:%SZ",
            "format": (
        ...
        "celery_task_json": {
            "()": "pint.core.logging.JsonCeleryTaskFormatter",
            "datefmt": "%Y-%m-%dT%H:%M:%SZ",
            "format": (
                "%(asctime)s %(levelname)s %(celeryTaskId)s %(celeryTaskName)s "
                "%(message)s "
...
if AWS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = "pint.core.storages.S3MediaStorage"
elif GS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = "pint.core.storages.GCSMediaStorage"
elif AZURE_CONTAINER:
    DEFAULT_FILE_STORAGE = "pint.core.storages.AzureMediaStorage"
...
#         "task": "pint.core.tasks.delete_event_payloads_task",
#         "schedule": timedelta(days=1),
#     },
