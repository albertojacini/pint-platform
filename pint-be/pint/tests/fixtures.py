        ...
        Initiative.objects.bulk_create(
            [
                Initiative(
                    ...
                    slug="test-initiative-a",
                ),
                Initiative(
                    title="Test initiative 2",
                    slug="test-initiative-b",
                ),
                Initiative(
                    title="Test initiative 3",
                    slug="test-initiative-c",
                ),
            ]
        )
    )
...
@pytest.fixture
def initiative_with_images(media_root):
    initiative = Initiative.objects.create(
        title="Test initiative",
        slug="test-initiative-7",
    )
    ...
    initiative.media.create(image=file_mock_0)
    initiative.media.create(image=file_mock_1)
    return initiative
