class WebhookEventType:
    ...
    INITIATIVE_VARIANT_CREATED = "initiative_variant_created"
    INITIATIVE_VARIANT_UPDATED = "initiative_variant_updated"
    INITIATIVE_VARIANT_DELETED = "initiative_variant_deleted"

    INITIATIVE_VARIANT_OUT_OF_STOCK = "initiative_variant_out_of_stock"
    INITIATIVE_VARIANT_BACK_IN_STOCK = "initiative_variant_back_in_stock"
    ...
    DISPLAY_LABELS = {
        ...
        INITIATIVE_CREATED: "Product created",
        INITIATIVE_UPDATED: "Product updated",
        INITIATIVE_DELETED: "Product deleted",
        INITIATIVE_VARIANT_CREATED: "Product variant created",
        INITIATIVE_VARIANT_UPDATED: "Product variant updated",
        INITIATIVE_VARIANT_DELETED: "Product variant deleted",
        INITIATIVE_VARIANT_OUT_OF_STOCK: "Product variant stock changed",
        INITIATIVE_VARIANT_BACK_IN_STOCK: "Product variant back in stock",
    ...
    CHOICES = [
        ...
        (INITIATIVE_CREATED, DISPLAY_LABELS[INITIATIVE_CREATED]),
        (INITIATIVE_UPDATED, DISPLAY_LABELS[INITIATIVE_UPDATED]),
        (INITIATIVE_DELETED, DISPLAY_LABELS[INITIATIVE_DELETED]),
        (INITIATIVE_VARIANT_CREATED, DISPLAY_LABELS[INITIATIVE_VARIANT_CREATED]),
        (INITIATIVE_VARIANT_UPDATED, DISPLAY_LABELS[INITIATIVE_VARIANT_UPDATED]),
        (INITIATIVE_VARIANT_DELETED, DISPLAY_LABELS[INITIATIVE_VARIANT_DELETED]),
        (INITIATIVE_VARIANT_OUT_OF_STOCK, DISPLAY_LABELS[INITIATIVE_VARIANT_OUT_OF_STOCK]),
        (INITIATIVE_VARIANT_BACK_IN_STOCK, DISPLAY_LABELS[INITIATIVE_VARIANT_BACK_IN_STOCK]),
