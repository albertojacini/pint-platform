...
class WebhookEventAsyncType:
    ...
    PERMISSIONS = {
        ...
        INITIATIVE_CREATED: InitiativePermissions.MANAGE_INITIATIVES,
        INITIATIVE_UPDATED: InitiativePermissions.MANAGE_INITIATIVES,
        INITIATIVE_DELETED: InitiativePermissions.MANAGE_INITIATIVES,
