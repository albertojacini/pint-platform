...
class Command(BaseCommand):
    ...
    placeholders_dir = "pint/static/placeholders/"
    ...
    def sequence_reset(self):
        """Run a SQL sequence reset on all pint.* apps.
    ...
    def handle(self, *args, **options):
        ...
        settings.PLUGINS = [
            ...
            "pint.payment.gateways.dummy_credit_card.plugin."
        ...
        create_initiatives(self.placeholders_dir, 20)
        self.stdout.write("Created initiatives")
