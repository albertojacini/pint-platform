# Generated by Django 3.2.15 on 2022-09-25 08:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this app extension.', to='auth.Permission')),
            ],
        ),
        migrations.AddIndex(
            model_name='app',
