...
def test_can_manage_group_user_superuser(
    admin_user, permission_group_manage_users, permission_manage_initiatives
):
...
def test_get_out_of_scope_permissions_user_has_all_permissions(
    staff_user, permission_manage_initiatives, permission_manage_users
):
    ...
    missing_perms = get_out_of_scope_permissions(
        staff_user, [AccountPermissions.MANAGE_USERS, InitiativePermissions.MANAGE_INITIATIVES]
    )
...
def test_get_out_of_scope_permissions_user_without_permissions(
    ...
    permissions = [AccountPermissions.MANAGE_USERS, InitiativePermissions.MANAGE_INITIATIVES]
...
def test_get_out_of_scope_permissions_app_has_all_permissions(
    app, permission_manage_initiatives, permission_manage_users
):
    app.permissions.add(permission_manage_initiatives, permission_manage_users)
    missing_perms = get_out_of_scope_permissions(
        app,
        [AccountPermissions.MANAGE_USERS, InitiativePermissions.MANAGE_INITIATIVES],
    )
    assert missing_perms == []
...
def test_get_group_permission_codes(
    db, permission_group_manage_users, permission_manage_initiatives
):
...
def test_get_user_permissions(db, permission_group_manage_users, permission_manage_initiatives):
...
def test_get_user_permissions_only_group_permissions(db, permission_group_manage_users):
    staff_user = permission_group_manage_users.user_set.first()
    group_permissions = permission_group_manage_users.permissions.all()
...
def test_get_user_permissions_only_permissions(staff_user, permission_manage_initiatives):
    staff_user.user_permissions.add(permission_manage_initiatives)
...
def test_get_groups_which_user_can_manage(
    ...
    manage_orders_group.permissions.add(permission_manage_initiatives)
...
def test_get_out_of_scope_users_user_has_rights_to_manage_all_users(
    ...
    staff_user1.user_permissions.add(
        permission_manage_political_entities, permission_manage_initiatives
    )
...
def test_get_out_of_scope_users_for_admin_user(
    ...
    staff_user2.user_permissions.add(permission_manage_initiatives)
...
def test_get_group_to_permissions_and_users_mapping(
    ...
    group2.permissions.add(permission_manage_political_entities, permission_manage_initiatives)
    ...
    excepted_result = {
        ...
        group2.pk: {
            "permissions": {
                InitiativePermissions.MANAGE_POLITICAL_ENTITIES.value,
                InitiativePermissions.MANAGE_INITIATIVES.value,
            },
            "users": set(),
        },
...
#         permission_manage_staff,
#     )
#     group2.permissions.add(permission_manage_initiatives, permission_manage_checkouts)
#     group3.permissions.add(permission_manage_political_entities, permission_manage_staff)
...
#         permission_manage_staff, permission_manage_initiatives, permission_manage_checkouts
#     )
#     group3.permissions.add(permission_manage_political_entities, permission_manage_staff)
...
def test_get_not_manageable_perms_removing_users_from_group_some_cannot_be_manage(
    ...
    group1.permissions.add(permission_manage_users)
    group2.permissions.add(permission_manage_staff)
    group3.permissions.add(permission_manage_users, permission_manage_initiatives)
...
def test_get_not_manageable_permissions_after_removing_perms_from_group_no_perms(
    ...
    group1.permissions.add(permission_manage_users, permission_manage_political_entities)
    group2.permissions.add(permission_manage_staff)
...
def test_can_manage_app_account(
    ...
    app.permissions.add(permission_manage_political_entities)
    staff_user.user_permissions.add(permission_manage_apps, permission_manage_political_entities)
...
def test_can_manage_app_for_app_no_permission(
    ...
    apps[1].permissions.add(permission_manage_political_entities)
...
def test_can_manage_app_for_app(
    ...
    apps = App.objects.bulk_create([App(name="sa1"), App(name="sa2")])
    apps[1].permissions.add(permission_manage_political_entities)
    apps[0].permissions.add(permission_manage_apps, permission_manage_political_entities)
...
def test_requestor_has_access_no_access_by_customer(staff_user, customer_user):
    ...
    result = is_owner_or_has_one_of_perms(
        customer_user, staff_user, InitiativePermissions.MANAGE_INITIATIVES
    )
...
def test_requestor_has_access_access_by_customer(customer_user):
    # when
    result = is_owner_or_has_one_of_perms(
        customer_user, customer_user, InitiativePermissions.MANAGE_INITIATIVES
    )
...
def test_requestor_has_access_access_by_staff(
    customer_user, staff_user, permission_manage_initiatives
):
    # given
    staff_user.user_permissions.add(permission_manage_initiatives)
    staff_user.save()
    ...
    # when
    result = is_owner_or_has_one_of_perms(
        staff_user, customer_user, InitiativePermissions.MANAGE_INITIATIVES
    )
...
def test_requestor_has_access_no_access_by_staff(
    customer_user, staff_user, permission_manage_political_entities
):
    # given
    staff_user.user_permissions.add(permission_manage_political_entities)
    staff_user.save()
