...
from ..core.enums import InitiativeErrorCode
...
#
#
# def get_used_variants_attribute_values(initiative):
#     """Create list of attributes values for all existing `InitiativeVariants` for initiative.
#
#     Sample result is:
#     [
#         {
...
#     """
#     variants = (
#         initiative.variants.prefetch_related("attributes__values")
...
# def create_stocks(
#     variant: "InitiativeVariant", stocks_data: List[Dict[str, str]], warehouses: "QuerySet"
# ):
#     try:
#         new_stocks = Stock.objects.bulk_create(
#             [
#                 Stock(
#                     initiative_variant=variant,
#                     warehouse=warehouse,
...
#         msg = "Stock for one of warehouses already exists for this initiative variant."
    ...
    with transaction.atomic():
        for order, media in enumerate(ordered_media):
            ...
            try:
                ...
                logger.warning(msg)
                errors["media"].append(
                    ValidationError(msg, code=InitiativeErrorCode.NOT_FOUND.value)
                )
