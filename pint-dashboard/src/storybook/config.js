...
function loadStories() {
  ...
  require("./stories/components/AssignInitiativeDialog");
  ...
  // Initiatives
  require("./stories/initiatives/InitiativeCreatePage");
  require("./stories/initiatives/InitiativeImagePage");
  require("./stories/initiatives/InitiativeListPage");
  require("./stories/initiatives/InitiativeUpdatePage");
  require("./stories/initiatives/InitiativeVariantCreatePage");
  require("./stories/initiatives/InitiativeVariantImageSelectDialog");
  require("./stories/initiatives/InitiativeVariantPage");
  ...
  require("./stories/orders/OrderInitiativeAddDialog");
  require("./stories/orders/OrderShippingMethodEditDialog");
  require("./stories/orders/OrderInvoiceList");

  // Initiative types
  require("./stories/initiativeTypes/InitiativeTypeCreatePage");
  require("./stories/initiativeTypes/InitiativeTypeDetailsPage");
  require("./stories/initiativeTypes/InitiativeTypeListPage");
