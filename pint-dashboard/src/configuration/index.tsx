...
// import InitiativeTypes from "@saleor/icons/InitiativeTypes";
...
// import { initiativeTypeListUrl } from "@saleor/initiativeTypes/urls";
...
export function createConfigurationMenu(intl: IntlShape): MenuSection[] {
  return [
    ...
    //     id: "HP6m+q",
    //     defaultMessage: "Attributes and Initiative Types",
    //   }),
    //   menuItems: [
    //     {
    //       description: intl.formatMessage({
    //         id: "19/lwV",
    //         defaultMessage: "Determine attributes used to create initiative types",
    //       }),
    //       icon: <Attributes />,
    //       permissions: [
    //         PermissionEnum.MANAGE_INITIATIVE_TYPES_AND_ATTRIBUTES,
    ...
    //       description: intl.formatMessage({
    //         id: "n0RwMK",
    //         defaultMessage: "Define types of initiatives you sell",
    //       }),
    //       icon: <InitiativeTypes />,
    //       permissions: [PermissionEnum.MANAGE_INITIATIVE_TYPES_AND_ATTRIBUTES],
    //       title: intl.formatMessage(sectionNames.initiativeTypes),
    //       url: initiativeTypeListUrl(),
    //       testId: "configuration-menu-initiative-types",
    //     },
    //   ],
    // },
    // {
    //   label: intl.formatMessage({
    //     id: "jFrdB5",
    //     defaultMessage: "Initiative Settings",
    //   }),
    //   menuItems: [
    //     {
    //       description: intl.formatMessage({
    ...
    //       }),
    //       icon: <Warehouses />,
    //       permissions: [PermissionEnum.MANAGE_INITIATIVES],
