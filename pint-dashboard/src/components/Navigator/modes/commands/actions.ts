...
import { initiativeAddUrl } from "@saleor/initiatives/urls";
...
export function searchInCommands(
  ...
  const actions: Command[] = [
    ...
    {
      label: intl.formatMessage(messages.createInitiative),
      onClick: () => {
        navigate(initiativeAddUrl());
        return false;
      },
    },
    {
...
function getCommandModeActions(
  ...
  return [...searchInCommands(query, intl, navigate, setMode)]
