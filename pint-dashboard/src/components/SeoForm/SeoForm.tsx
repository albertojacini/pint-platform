...
import { getFieldError, getInitiativeErrorMessage } from "@saleor/utils/errors";
...
interface SeoFormProps {
  ...
  disabled?: boolean;
  errors?: Array<
    PageErrorFragment | InitiativeErrorFragment | CollectionErrorFragment
  >;
  loading?: boolean;
  helperText?: string;
...
const SeoForm: React.FC<SeoFormProps> = props => {
  ...
  const getSlugErrorMessage = () => {
    ...
    return type === "InitiativeError"
      ? getInitiativeErrorMessage(error as InitiativeErrorFragment, intl)
