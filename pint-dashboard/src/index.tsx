...
import { SaleorProvider } from "./saleor-sdk/src/react/components/SaleorProvider"
...
import InitiativeSection from "./initiatives";
        ...
        <AppLayout fullSize={isAppPath}>
          ...
          >
            <Switch>
              ...
              {/*  component={InitiativeTypesSection}*/}
              {/*/>*/}
              <SectionRoute
