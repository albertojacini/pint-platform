...
import { InitiativeType } from "@saleor/sdk/dist/apollo/types";
...
export const initiative: (
  ...
  InitiativeVariantCreateDataQuery["initiative"] = placeholderImage => ({
  __typename: "Initiative" as "Initiative",
  attributes: [
    {
  ...
  channelListings: [
    {
      __typename: "InitiativeChannelListing",
      availableForPurchase: null,
      channel: channelsList[0],
      isAvailableForPurchase: false,
      isPublished: true,
      pricing: {
        __typename: "InitiativePricingInfo",
        priceRange: {
  ...
  defaultVariant: { __typename: "InitiativeVariant", id: "pv75934" },
      ...
      channelListings: [
        {
          ...
          __typename: "InitiativeVariantChannelListing",
        },
        {
          channel: {
            id: "Q2hhbm5lbDoy",
...
export const initiatives = (
  placeholderImage: string,
): RelayToFlat<InitiativeListQuery["initiatives"]> => [
  {
...
export const variant = (placeholderImage: string): InitiativeVariantFragment => ({
  __typename: "InitiativeVariant",
  channelListings: [
    {
      __typename: "InitiativeVariantChannelListing",
...
export const variantInitiativeImages = (placeholderImage: string) =>
  variant(placeholderImage).initiative.media;
export const variantSiblings = (placeholderImage: string) =>
  variant(placeholderImage).initiative.variants;

export const initiativeTypesList: Array<Pick<
  InitiativeType,
  "id" | "name" | "hasVariants"
>> = [
  {
