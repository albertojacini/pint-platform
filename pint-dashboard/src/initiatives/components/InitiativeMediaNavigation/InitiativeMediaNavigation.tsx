...
const useStyles = makeStyles(
  ...
  { name: "InitiativeMediaNavigation" },
);

interface InitiativeMediaNavigationProps {
  disabled: boolean;
  media?: Array<{
    id: string;
    url: string;
...
const InitiativeMediaNavigation: React.FC<InitiativeMediaNavigationProps> = props => {
...
InitiativeMediaNavigation.displayName = "InitiativeMediaNavigation";
export default InitiativeMediaNavigation;
