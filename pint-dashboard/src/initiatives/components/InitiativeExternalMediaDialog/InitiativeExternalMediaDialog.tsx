...
interface InitiativeExternalMediaDialogProps {
...
const InitiativeExternalMediaDialog: React.FC<InitiativeExternalMediaDialogProps> = ({
  open,
  onClose,
  onSubmit,
}) => {
...
export default InitiativeExternalMediaDialog;
