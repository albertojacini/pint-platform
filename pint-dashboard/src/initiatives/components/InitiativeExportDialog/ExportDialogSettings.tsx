...
const ExportDialogSettings: React.FC<ExportDialogSettingsProps> = ({
  ...
  const initiativeExportTypeChoices: Array<RadioGroupFieldChoice<
    FileTypesEnum
  >> = [
    {
  ...
  return (
    <>
      {allowScopeSelection && (
        <>
          <RadioGroupField
            ...
            name={"scope" as keyof ExportInitiativesInput}
            onChange={onChange}
            value={data.scope}
          />
      ...
      <RadioGroupField
        choices={initiativeExportTypeChoices}
        ...
        name={"fileType" as keyof ExportInitiativesInput}
        onChange={onChange}
        value={data.fileType}
      />
    </>
