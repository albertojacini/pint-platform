...
import useInitiativeExportFieldMessages from "./messages";
...
const inventoryFields = [
  InitiativeFieldEnum.INITIATIVE_WEIGHT,
  InitiativeFieldEnum.VARIANT_ID,
  InitiativeFieldEnum.VARIANT_SKU,
  InitiativeFieldEnum.VARIANT_WEIGHT,
];
...
const useStyles = makeStyles(
  ...
  {
    name: "InitiativeExportDialogInfo",
  },
);
...
const FieldAccordion: React.FC<AccordionProps & {
  data: ExportInitiativesInput;
  fields: InitiativeFieldEnum[];
  onChange: (event: ChangeEvent) => void;
  onToggleAll: (field: InitiativeFieldEnum[], setTo: boolean) => void;
}> = ({ data, fields, onChange, onToggleAll, ...props }) => {
  const classes = useStyles({});
  const getFieldLabel = useInitiativeExportFieldMessages();
...
export interface InitiativeExportDialogInfoProps extends FetchMoreProps {
...
const InitiativeExportDialogInfo: React.FC<InitiativeExportDialogInfoProps> = ({
  attributes,
  // channels,
  data,
  hasMore,
  ...
  const handleToggleAllFields = (fields: InitiativeFieldEnum[], setTo: boolean) =>
    onChange({
      target: {
        name: "exportInfo",
        value: {
    ...
    <>
      <Typography className={classes.dialogLabel}>
        <FormattedMessage
          ...
          description="select initiative informations to be exported"
        />
      </Typography>
      ...
      {/*      id: "64aYF0",*/}
      {/*      defaultMessage: "Initiative Organization",*/}
      {/*      description: "informations about initiative organization, header",*/}
      {/*    })}*/}
      {/*    data={data}*/}
      {/*    fields={[*/}
      {/*      InitiativeFieldEnum.CATEGORY,*/}
      {/*      InitiativeFieldEnum.COLLECTIONS,*/}
      {/*      InitiativeFieldEnum.INITIATIVE_TYPE,*/}
      {/*    ]}*/}
      ...
      {/*      description: "informations about initiative prices etc, header",*/}
      {/*    })}*/}
      {/*    data={data}*/}
      {/*    fields={[InitiativeFieldEnum.CHARGE_TAXES]}*/}
      {/*    onChange={handleFieldChange}*/}
      {/*    onToggleAll={handleToggleAllFields}*/}
      ...
      {/*      description: "informations about initiative stock, header",*/}
      {/*    })}*/}
      {/*    quickPeek={*/}
      ...
      {/*      <FormattedMessage*/}
      {/*        id="ZRz3hM"*/}
      {/*        defaultMessage="Export Initiative Stock Quantity to CSV"*/}
      {/*      />*/}
      {/*    </Typography>*/}
      {/*    <div>*/}
      {/*      <Option*/}
      ...
      {/*      description: "informations about initiative seo, header",*/}
      {/*    })}*/}
      {/*    data={data}*/}
      {/*    fields={[*/}
      {/*      InitiativeFieldEnum.DESCRIPTION,*/}
      {/*      InitiativeFieldEnum.NAME,*/}
      {/*      InitiativeFieldEnum.INITIATIVE_MEDIA,*/}
      {/*      InitiativeFieldEnum.VARIANT_MEDIA,*/}
      {/*    ]}*/}
      {/*    onChange={handleFieldChange}*/}
      {/*    onToggleAll={handleToggleAllFields}*/}
      {/*    data-test-id="seo"*/}
...
InitiativeExportDialogInfo.displayName = "InitiativeExportDialogInfo";
export default InitiativeExportDialogInfo;
