...
import { InitiativeMediaFragment, InitiativeMediaType } from "@saleor/graphql";
import { makeStyles } from "@saleor/macaw-ui";
import { InitiativeMediaPopper } from "@saleor/initiatives/components/InitiativeMediaPopper/InitiativeMediaPopper";
...
interface MediaListContainerProps {
  className: string;
  media: InitiativeMediaFragment[];
  preview: InitiativeMediaFragment[];
...
const InitiativeMedia: React.FC<InitiativeMediaProps> = props => {
  const {
    media,
    placeholderImage,
    getImageEditUrl,
...
InitiativeMedia.displayName = "InitiativeMedia";
